import { X, User, Shield, Binary, Calendar } from 'lucide-react'
        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative w-full max-w-2xl border-x border-gold/40 bg-space-deep/90 p-12 shadow-[0_0_100px_rgba(255,215,0,0.1)] overflow-hidden"
                >
                    {/* Cyber Decor */}
                    ...
                    <button onClick={() => setVaultActive(false)} className="absolute top-6 right-6 text-white/40 hover:text-white transition-colors">
                        <X className="w-6 h-6" />
                    </button>
                    ...
                    <header className="text-center mb-12">
                        <motion.div
                            ...
                            className="inline-block px-4 py-1 border border-gold/20 text-gold font-mono text-[10px] tracking-[0.5em] uppercase mb-4"
                        >
                    ...
                    <div className="grid grid-cols-2 gap-8 font-mono">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-4 border border-white/5 bg-white/5">
                                ...
                                <div>
                                    <div className="text-[10px] text-white/40">ORIGIN_UNIX</div>
                                    <div className="text-xs text-white">19.06.2002</div>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-4 border border-white/5 bg-white/5">
